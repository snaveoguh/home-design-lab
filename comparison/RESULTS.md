...
**Question.** Does giving Jesse's factory our four skills change what it produces, and how does either compare with a hand-designed screen and with his real PR #675 output?
...
| Hand-designed lab | this repo's `home/`, review chrome hidden | `entries/C-*.png` |
...
| --- | --- | --- |
| 1 | Hand-designed lab | Hand-designed lab |
| 2 | Upstream + skills | Upstream + skills |
| 3 | Upstream only | Jesse's C |
| 4 | Jesse's B | Upstream only |
| 5 | Jesse's C | Jesse's B |

Both critics, independently and blind, put the skills arm above the no-skills arm and above both of Jesse's real treatments. Both put the hand-designed lab first. The rubric critic's blocker on Jesse's entries is for missing loading and pending states that his brief never asked for, so read his placement on the other sections; the upstream-style critic had no such rule and still ranked the skills arm above his C.
