...
GitHub Pages serves this repo through `.github/workflows/pages.yml` (Settings → Pages → Source: GitHub Actions), with `index.html` redirecting to `home/`. Live at https://snaveoguh.github.io/home-design-lab/ Netlify or any static host works the same way with no build step.
